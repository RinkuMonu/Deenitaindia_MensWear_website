      ...
      <div className="container mx-auto py-12 px-4">
        ...
        <div className="text-center mb-12 pb-8 border-b border-gray-200">
          <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ color: "#1B2E4F" }}>
            Order <span style={{ color: "rgb(120 120 120)" }}>History</span>
          </h1>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-8">
          <div className="flex flex-col lg:flex-row gap-6 items-start lg:items-center justify-between">
            <div className="flex items-center gap-3">
              <Filter className="w-5 h-5" style={{ color: "rgb(120 120 120)" }} />
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                      <div className="text-right">
                        <p className="text-2xl font-bold" style={{ color: "rgb(120 120 120)" }}>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 text-center">
              <div
                ...
                style={{ background: "rgba(120, 120, 120, 0.3)" }}
              >
                <span className="text-lg font-bold" style={{ color: "rgb(120 120 120)" }}>
                  ₹
                </span>
              </div>
              <p className="text-2xl font-bold text-gray-900">
